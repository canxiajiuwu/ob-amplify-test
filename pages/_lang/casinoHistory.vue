<template>
  <div class="cl-accountTransactionHistory-wrap">
    <div class="cl-topBox">
      <headBack
...
import accountTransactionBox from '@/components/components/accountCasinoTransactionBox.vue'
...
.cl-accountTransactionHistory-wrap {
  width: 10rem;
  min-height: 100vh;
