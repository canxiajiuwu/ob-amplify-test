...
<template>
  <div
    class="cl-relative cl-flex cl-items-top cl-justify-center cl-min-h-screen cl-bg-gray-100 cl-sm:items-center cl-sm:pt-0"
  >
    <link
      href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css"
      rel="stylesheet"
    />
    <div class="cl-max-w-4xl cl-mx-auto cl-sm:px-6 cl-lg:px-8">
      <a
        class="cl-flex cl-justify-center cl-pt-8 cl-sm:pt-0"
      ...
      <div class="cl-mt-8 cl-bg-white cl-overflow-hidden cl-shadow cl-sm:rounded-lg cl-p-6">
        <h2 class="cl-text-2xl cl-leading-7 cl-font-semibold">
          Welcome to your Nuxt Application
        </h2>
        <p class="cl-mt-3 cl-text-gray-600">
          We recommend you take a look at the
          <a
            href="https://nuxtjs.org"
            target="_blank"
            class="cl-button--doc cl-text-green-500 cl-hover:underline"
            >Nuxt Documentation</a
          >, whether you are new or have previous experience with the
          framework.<br />
        </p>
        <p class="cl-mt-4 cl-pt-4 cl-text-gray-800 cl-border-t cl-border-dashed">
          To get started, remove
          <code class="cl-bg-gray-100 cl-text-sm cl-p-1 cl-rounded cl-border"
      ...
      <div class="cl-flex cl-justify-center cl-pt-4 cl-space-x-2">
        <a href="https://github.com/nuxt/nuxt.js" target="_blank"
          ><svg
            class="cl-w-6 cl-h-6 cl-text-gray-600 cl-hover:text-gray-800 cl-button--github"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://twitter.com/nuxt_js" target="_blank"
          ><svg
            class="cl-w-6 cl-h-6 cl-text-gray-600 cl-hover:text-gray-800"
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            aria-hidden="true"
            role="img"
