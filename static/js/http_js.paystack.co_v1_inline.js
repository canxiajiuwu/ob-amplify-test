!(function () {
  ...
  ;(Inline.prototype.setTransaction = function (t) {
    ...
    (Inline.prototype.setupEmbed = function () {
      const t = document.getElementById(this.defaults.container)
      ;(t.innerHTML = ''),
    ...
    (Inline.prototype.setupOldPopup = function () {
      const t = 10 * findHighestZIndex('div');
        let e = 'z-index: ' + Math.max(t, 999999)
      ;(e +=
    ...
    (Inline.prototype.getTransactionParameters = function () {
      ...
      const t = omitKeys(this.defaults, [
        'customButton',
        'onClose',
        'callback',
        'tlsFallback'
      ...
      return (
        (t.mode = 'popup'),
        (t.hasTLSFallback = this.defaults.tlsFallback !== null),
        t.metadata &&
          typeof t.metadata != 'string' &&
          (t.metadata = JSON.stringify(t.metadata)),
        void 0 !== t.card &&
          ['false', !1].includes(t.card) &&
          ((t.channels = ['bank']), delete t.card),
        void 0 !== t.bank &&
          ['false', !1].includes(t.bank) &&
          ((t.channels = ['card']), delete t.bank),
        t
      )
    }),
    (Inline.prototype.getOldCheckoutURL = function () {
      let t = config.siteUrl + 'assets/payment/production/inline.html';
        const e = this.getTransactionParameters()
    ...
    (Inline.prototype.updateIframe = function () {
      if (this.isEmbed) this.iframe.src = this.getOldCheckoutURL()
      else {
        const t = this.getTransactionParameters();
          const e = t ? 'newTransaction' : 'popup'
    ...
    (Inline.prototype.handleOldCheckoutEvents = function (t) {
      ...
      if (n && (typeof n == 'string' || n instanceof String)) {
        const r = parseResponse(n, e.defaults);
          const i = r.isThisIframe && r.action === 'PaystackClose';
          const a = r.action === 'close'
        if (i || a) {
          const o = r.data
    ...
    (Inline.prototype.listenForResizeEvent = function () {
      ...
      eventer(
        messageEvent,
        function (t) {
          const e = t.data || t.message
          if (e && (typeof e == 'string' || e instanceof String)) {
            const n = parseResponse(e, r.defaults)
            if (!n.isThisIframe || n.action != 'PaystackResize') return
    ...
    (Inline.prototype.openOldCheckout = function () {
      ...
      if (!this.iframeOpen) {
        const t = function () {
          const t = document.getElementById(e.defaults.id)
    ...
    (Inline.prototype.closeOldCheckout = function () {
      if (this.iframeOpen && !this.isEmbed) {
        const t = document.getElementById(this.defaults.id)
    ...
    (Inline.prototype.setupNewPopup = function () {
      ...
      const e = this.background.contentWindow.document
      e.open(),
        e.write(
    ...
    (Inline.prototype.handleNewCheckoutEvents = function (t) {
      if (
        ...
        const e = t.data || t.message
        if (
          (e === 'loaded:checkout' && this.isIframeOpen && this.updateIframe(),
          e === 'loaded:transaction' && this.removeLoader(),
          e === 'close')
        ) {
    ...
    (Inline.prototype.closeNewCheckout = function (t) {
      ...
      ;(e.background.style.opacity = 0),
        ...
        (e.isIframeOpen = !1),
        setTimeout(function () {
          e.resetNewCheckout(), t && e.removeNewCheckout()
        }, 300)
    }),
          ...
          if (isValid(r))
            return e
              ? (checkForParentForm(e),
                ba.setTransaction(r),
                ba.setForm(getParentForm(e)),
                void (window[n] = ba))
              : (ba.setTransaction(r), ba)
        }
      });
    let ba
  ...
  var sourceScript =
      ...
      ((ga = document.getElementsByTagName('script')), ga[ga.length - 1]);
    let ga
  ...
  function isValid(t) {
    ...
    if (t.bearer && t.bearer != 'account' && t.bearer != 'subaccount')
    ...
    if (
      t.customButton &&
      t.customButton != null &&
      document.getElementById(t.customButton) == null
    )
      throw new Error(
    ...
    if (
      t.container &&
      t.container != null &&
      document.getElementById(t.container) == null
    )
      throw new Error(
  ...
  function checkForParentForm(t) {
    if (t.parentElement.tagName == 'FORM') return !0
    throw new Error(
  ...
  function hasDataAttribute(t) {
    ...
    for (key in (n = Array.prototype.slice.call(n))) {
      const r = n[key].nodeName
      r && r.includes('data') && (e = !0)
    }
    return e
  }
  function noBrowserIframeSupport() {
    const t = 'onload' in document.createElement('iframe')
    return (
      t ||
        console.warn(
  ...
  function omitKeys(t, e) {
    for (var n = JSON.parse(JSON.stringify(t)), r = 0; r < e.length; r++)
      delete n[e[r]]
    for (const i in n) n.hasOwnProperty(i) && !n[i] && delete n[i]
    return n
  }
  ...
  function isObject(t) {
    return (
      t === Object(t) && Object.prototype.toString.call(t) !== '[object Array]'
    )
  }
  function isArray(t) {
  ...
  function getHref() {
    ...
    return t && t.length > 500 && (t = t.split('?')[0]), t
  }
  ...
  function cssLoad(t, e) {
    ...
    function d() {
      s = !0
      for (let t = 0, e = a.length; t < e; t++) a[t]()
    }
    function l() {
      c = !0
      ...
      void 0 !== u.addEventListener
        ...
        : void 0 !== u.attachEvent &&
          u.attachEvent('onload', function () {
            let t;
              let e = document.styleSheets.length
            try {
              for (; e--; )
  ...
  (function (t) {
    ...
    if (!t.fetch) {
      var e = 'URLSearchParams' in t;
        var n = 'Symbol' in t && 'iterator' in Symbol;
        var o =
          'FileReader' in t &&
          'Blob' in t &&
          (function () {
      ...
      if (i)
        var a = [
          ...
          c =
            ArrayBuffer.isView ||
            function (t) {
              return t && a.includes(Object.prototype.toString.call(t))
            }
      ...
      ;(w.prototype.clone = function () {
        ...
        (_.error = function () {
          const t = new _(null, { status: 0, statusText: '' })
          return (t.type = 'error'), t
        })
      const l = [301, 302, 303, 307, 308]
      ;(_.redirect = function (t, e) {
        if (!l.includes(e)) throw new RangeError('Invalid status code')
        ...
        (t.fetch = function (n, i) {
          return new Promise(function (r, t) {
            ...
            ;(a.onload = function () {
              ...
              const n = 'response' in a ? a.response : a.responseText
              r(new _(n, e))
            }),
              (a.onerror = function () {
    ...
    function g() {
      return (
        ...
        (this._initBody = function (t) {
          if ((this._bodyInit = t))
            if (typeof t == 'string') this._bodyText = t
    ...
    function w(t, e) {
      ...
      if (t instanceof w) {
        ...
        ;(this.url = t.url),
          ...
          (this.mode = t.mode),
          i || t._bodyInit == null || ((i = t._bodyInit), (t.bodyUsed = !0))
      ...
      return (
        t
          ...
          .forEach(function (t) {
            if (t) {
              const e = t.split('=');
                const n = e.shift().replace(/\+/g, ' ');
                const r = e.join('=').replace(/\+/g, ' ')
  ...
  (function (t, e) {
      ...
      n._state !== 0
        ? ((n._handled = !0),
          a._immediateFn(function () {
            const t = n._state === 1 ? r.onFulfilled : r.onRejected
            if (t !== null) {
              let e
              try {
                e = t(n._value)
              ...
              o(r.promise, e)
            } else (n._state === 1 ? o : s)(r.promise, n._value)
          }))
        : n._deferreds.push(r)
    }
    function o(e, t) {
    ...
    function c(t) {
      ...
      for (let e = 0, n = t._deferreds.length; e < n; e++) i(t, t._deferreds[e])
      t._deferreds = null
    }
    function d(t, e) {
      let n = !1
    ...
    ;(a.prototype.catch = function (t) {
      ...
      (a.race = function (i) {
        return new a(function (t, e) {
          for (let n = 0, r = i.length; n < r; n++) i[n].then(t, e)
        })
      }),
      (a._immediateFn =
