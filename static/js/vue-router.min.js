...
!(function (t, e) {
    ...
    const e = t
      ? Object.keys(t)
          .map(function (e) {
            const r = t[e]
            if (void 0 === r) return ''
            if (r === null) return Pt(e)
            if (Array.isArray(r)) {
              const n = []
              return (
                r.forEach(function (t) {
                  void 0 !== t &&
                    (t === null ? n.push(Pt(e)) : n.push(Pt(e) + '=' + Pt(t)))
                }),
                n.join('&')
              )
            }
  ...
  function l(t, e) {
    return (
      t.path.replace(Mt, '/').indexOf(e.path.replace(Mt, '/')) === 0 &&
  ...
  function U(t, e, r, n, o, i) {
    ...
    const p = {
      ...
      meta: n.meta || {},
      props:
        n.props == null ? {} : n.components ? n.props : { default: n.props }
    }
    n.children &&
      ...
      void 0 !== n.alias &&
        (Array.isArray(n.alias) ? n.alias : [n.alias]).forEach(function (i) {
          const a = { path: i, children: n.children }
          U(t, e, r, a, o, p.path || '/')
        }),
  ...
  function z(t, e) {
    function r(t, r, n) {
      ...
      if (a) {
        ...
        if (
          (typeof o.params != 'object' && (o.params = {}),
          r && typeof r.params == 'object')
        )
          for (const h in r.params)
            !(h in o.params) && f.includes(h) && (o.params[h] = r.params[h])
        if (u)
          return (
    ...
    function n(t, n) {
      ...
      if (
        (typeof a == 'string' && (a = { path: a }), !a || typeof a != 'object')
      )
        return i(null, n)
      const c = a;
        const s = c.name;
  ...
  function dt(t, e) {
    return typeof t != 'function' && (t = Tt.extend(t)), t.options[e]
  }
  function yt(t) {
  ...
  let Tt;
    ...
    var Mt = /\/?$/;
    var Ht = u(null, { path: '/' });
    const It = [String, Object];
    const Vt = [String, Array];
    var zt = {
      name: 'router-link',
      props: {
      ...
      render: function (t) {
        ...
        Array.isArray(this.event)
          ...
          : (k[this.event] = x)
        const R = { class: s }
        if (this.tag === 'a') (R.on = k), (R.attrs = { href: c })
        else {
    ...
    var Bt = typeof window != 'undefined';
    var Ft =
      Array.isArray ||
      function (t) {
  ...
  var Xt = Object.create(null);
    ...
    var Wt =
      ...
      (function () {
        ...
        return (
          ((!t.includes('Android 2.') &&
            !t.includes('Android 4.0')) ||
            !t.includes('Mobile Safari') ||
            t.includes('Chrome') ||
  ...
  const re = (function (t) {
    ...
    const ie = function (t) {
      ...
      let e = t.mode || 'hash'
      switch (
        ((this.fallback = e === 'history' && !Wt && !1 !== t.fallback),
    ...
    const ae = { currentRoute: { configurable: !0 } }
  return (
