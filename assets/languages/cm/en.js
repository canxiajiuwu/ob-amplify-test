...
module.exports = {
  ...
  units: 'XAF ',
  areaCode: '+237',
  cashoutLang: require('./cashout_en'),
  ...
  reminder: {
    ...
    password:
      'Enter a combination of letters and numbers at least 4 characters long',
    ...
    login:
      'Please enter a valid 10-digit mobile phone number, e.g.: 06xxxxxxxx',
    passwordTip:
      "Your password must be 4 digits, letters and symbols won't be accepted.",
    passwordRestriction: '4 digits (0-9)',
    rePsdJoinNow: 'This filled number has been registered on OneBet.',
    rePsd:
      "The password doesn't match your account! Forgot your password? <span style='font-weight: bold;text-decoration: underline;'>Generate a new one.</span>",
    withdraw1: 'Your money is not enough.',
    withdraw2: 'You can withdraw up to XAF {amount} per transaction.',
    withdraw3: 'The minimum withdraw amount is XAF {amount} per transaction',
    withdraw5: 'You can withdraw at most XAF {amount} per transaction',
    withdraw4:
    ...
    sureAbandonUsing:
      'Lower your stakes will cause the cash gfit cant be used, are you sure to abandon using this gift?',
    continueUse: 'Continue to Use',
    abandon: 'Abandon',
    remind: "Remember my choice and don't remind next time",
  ...
  accountGiftList: {
    friendStr:
      "Hey dear friend, it seems there is a Freebet in your account didn't use yet! Go check in your Freebet account and use it now!",
    ...
    betAmount: 'Betting amount > {amount} XAF,',
    betCount: 'Bet times > {count},',
    depositAmount: 'Deposit amount > {amount} XAF',
    unlock: 'Unlock',
    freeBet: 'FreeBet',
    freeBetTickets: 'FreeBet Tickets',
    accomplishNow: 'Accomplish Now',
    present:
      'This FreeBet is get from {get}, you can withdraw the winning money to your account after {after}',
    freeStake: 'Free Stake',
    payout: 'Payout',
    bottomTitle: ['Payout Locked', 'Payout has been unlocked', 'Withdrew'],
    bottomTitleExpired: 'Expired! Unable to withdraw.',
    btn: ['Unlock', 'Withdraw to account', ''],
    instructionExpire:
      'The order withdrawal window has expired and the winning funds can no longer be withdrawn.',
    filterArr: ['All', 'To unlock', 'Withdrawable', 'Credited'],
    from: ['New User Registration', 'Invite Friends', 'Recall Friends'],
    after0:
      'Place a bet that odds ≥ {odd}, cumulative betting amount {amount}XAF',
    after1:
      'Friend Places a bet that odds > {odd}, cumulative betting amount {amount}XAF',
    after2:
      'Place a bet that odds ≥ {odd}, cumulative betting amount {amount}XAF',
    withdrawMoney: 'Withdraw Money to Account',
    goingWithdraw:
      'Congratulations!<br/>Your Freebet won: XAF {money}, withdraw it to your account balance now?',
    instruction1:
      "Congratulations, you've reached the requirements of withdrawal, press withdraw button to withdraw Free Bet payout to your OneBet account balance any time.",
    instruction2:
      'There is no withdrawable money, kindly be patient to wait for the settlement.',
    instruction3:
      'The pay out money {money} XAF has been withdrawn to your account balance, you can check in the inbox.',
    lock1:
      'Due to the total betting amount of your friend +{phone} didn\'t reach {money} XAF, you can\'t withdraw the winning Freebet payout to your account balance,<span style="color: #4C50FA;text-decoration: underline;">Learn more</span> <br/><br/>Unlock the payout by asking your friend to bet on OneBet now:',
    lock2:
      "Due your betting amount didn't reach {money} XAF, the winning Freebet payout can not be withdrawn to your account balance.Bet now to unlock the payout"
  },
  accountInboxBox: {
  ...
  betslipPlaceBet: {
    ...
    oddsExpire: 'some odds expired',
    addMore: 'Add More Markets',
    oddTitle: "Odds didn't match",
    stakeTitle: 'Change Stakes'
  },
  betslipRelatedBets: {
    title: 'Related bets'
  },
  ...
  betslipSuccess: {
    ...
    cash: 'Cash Gifts',
    share:
      "Get extra <span style='color: #FA6B52;'>10,000,000 XAF</span> by sharing your bet! <span style='color: #2750CA; text-decoration: underline'>SHARE NOW</span>",
    betRefund:
  ...
  createBetslip: {
    ...
    merge: 'Merge local tickets',
    choose: 'Choose cash gift',
    stake: 'Stake',
    desired: 'Desired winnings',
    starts: 'Starts in',
    hour: 'hour',
    folds: 'Market Folds',
    ...
    create: 'Create',
    reminder1:
      "Lower your stakes will cause the cash gift can't be used, are you sure to modify the amount to abandon using this gift?",
    reminder2:
      "Lower your Desired winnings  will cause the cash gift can't be used, are you sure to modify the Desired winnings to abandon using this gift?",
    reminderDesired: 'The minimum desired winnings must over stake',
    reminderDesired1: 'Your local tickets amount is over desired winnings.',
    reminderMarkets: 'The range of market folds is 2 - 20',
    reminderMarkets1:
      'Your local ticket markets is over the market folds range',
    reminderFail:
      'Failed to create ticket, please adjust parameters and try again.',
    reminderGiftStake: 'To use this gift your minimum stake must be {stake}',
    reminderGiftWinning:
      'To use this gift your minimum desired winnings must be {stake}'
  },
  coinsSpin: {
    play: 'Play',
    pay: 'About to Pay 20 Coins',
    reminder: 'Congratulations! You won XAF {prize}.',
    prizes: [
      'Try Again',
      '1000 Cash',
      '10000 Cash',
  ...
  footer: {
    ...
    online: 'Online Help',
    reminder:
      'You have to be 25 years and above to bet. Betting is addictive and can be psychologically harmful.<br><br> Onebet is regulated by The National Gaming Board Cameroon. Licence #000012'
  },
  countryInfo: {
    change: 'change',
    ug: 'Uganda',
  ...
  footerMenu: {
    ...
    bonusLess: `Add <span style='color: ${mainThemeColor};font-weight: bold;'>{number}</span>
      bet with 1.20 or more odds to activate a <span style='color: ${mainThemeColor};font-weight: bold;'>{percent}</span>
      Bonus Boost.`,
    bonusMore: `Add <span style='color: ${mainThemeColor};font-weight: bold;'>1</span>
      more bet with 1.20 or more odds to get a <span style='color: ${mainThemeColor};font-weight: bold;'>{percent}</span>
      Bonus Boost.`,
    boost: 'XAF {money} ({percent}) Bonus Boost',
  ...
  homeMenu: {
    freebet: 'FreeBet',
    search: 'Search Teams, Leagues, Game ID, Odds',
    home: 'Home',
    jackpot: 'Jackpot',
    result: 'Results',
    deposit: 'Deposit',
  ...
  jackpotHowToPlay: {
    ...
    art3: 'To take part and have a chance to win the jackpot, you must get registered and have at least XAF 100 in your account. If you correctly predict all 13 match results, you win the Super Jackpot prize! Consolation prizes are awarded also for correctly predicting 12 or 11 match results.',
    art4: 'How to Take Part',
    art5: 'Make your selections – On the OneBet 13 Jackpot competition entry page, make your predictions for each one of the listed matches (Home win, Draw, Away win). Stake amount of each combination is XAF 100. You can make more than 1 prediction for one match. This will increase the stake amount by XAF 100 for every each additional combination formed by your selections.',
    art6: 'Check and place bets – Make sure to check all of the selections before you click on the "Place Bet" button. Once submitted, the bets cannot be cancelled, amended or refunded. You may place bets until 17:00 Saturday at Cameroon time. The countdown to the competition’s closure time is clearly shown on the competition entry page.',
    art7: 'Check the results – on Monday Afternoon at Cameroon Time, all match results and prizes will be published in the "Previous Results" on "Jackpot" page.',
    art8: 'Auto Pick',
    art9: 'By choosing the “Jackpot Rush” option, a random selection of one prediction per match will be automatically selected with a fixed stake of XAF 100. Further predictions may be added to the random selection. This will increase the cost of the entry by XAF 100 for every additional combination.'
  },
  jackpots: {
    title: 'JACKPOTS',
    ...
    helpGrand: [
      ...
      {
        title: 'Auto Pick',
        text: 'By choosing the “Jackpot Rush” option, a random selection of one prediction per match will be automatically selected with a fixed stake of XAF 100. Further predictions may be added to the random selection. This will increase the cost of the entry by XAF 100 for every additional combination.'
      }
    ]
  },
  jackpotsWeeklyCash: {
    ...
    notice: [
      ...
      "Weekly random choose 20 Lucky users,Each lucky user will get <span style='color:#fe415a'>400</span> XAF cash!", // x,xxx 货币单位 cash!
      "1 most lucky user will be chosen, Get <span style='color:#fe415a'>2,000</span> XAF CASH", // x,xxx 货币单位 CASH
    ...
    noticeWinning: {
      ...
      contentBehind:
        ' XAF in last Daily Jakpots and the money has been credited to your OneBet account.',
      ok: 'OK'
    },
    monetaryUnit: 'XAF'
  },
  ...
  account: {
    ...
    nickname1: 'Nickname',
    note: 'Note',
    note1: '1. Only first time change nickname can get 100 cash gift',
    note2: '2. Only first time set profile picture can get 100 cash gift',
    note3: '3. Profile picture and nickname can modify only once every 30 days',
    completeTitle: 'Complete Account Information',
    completeInfo:
      'You can get 100 cash gift after perfecting your nickname and profile picture.',
    setting: 'Go to set',
    setTeam: 'Set Home Team',
    setLeague: 'Set Favorite League',
    card1: 'Casino saving card, highest save <span>1232 XAF</span> per month\n',
    card2: "<span>{r_num} XAF</span> wasn't claimed yet in this period\n",
    card3: '<span>{saving_money} XAF</span>  money has been saved\n',
    card4:
      '<span>{saving_money} XAF</span>  money has been saved, able to claim <span>{t_amount} XAF</span> in next period.\n',
    card5:
      'Renew now to get another <span>{t_amount} XAF</span> Gifts next period\n',
    check: 'Check',
    claim: 'Claim',
    Renew: 'Renew',
    sportsgifts: '{num} Sports Gifts will be expired',
    casinogifts: '{num} Casino Gifts will be expired',
  ...
  accountDeposit: {
    ...
    art1: 'Please ensure there is enough money in your {name} mobile money account before deposit.',
    ...
    airtel: '(AIRTEL)',
    topUp: 'Deposit',
    art2: 'Deposit XAF 2000 or more from your mobile money wallet to your OneBet account wallet. All mobile money transaction fees will be charged on your account, then the same amount charged is automatically refunded into your OneBet account wallet on top of the initial deposit',
    ...
    mtnReminder:
      "Orange is under maintenance! Kindly use MTN to {method} instead, we'll inform you as soon as Orange restored."
  },
  accountForgetStep1: {
    number: '06XXXXXXXX',
  ...
  accountRegister: {
    ...
    bottom: 'By registering for an account, you agree to our <br>Terms of Use.',
    isRegistered:
  ...
  accountWithdraw: {
    ...
    bottomList: [
      '1.Maximum per transaction is XAF ',
      '2.Maximum Daily Transaction value is XAF ',
  ...
  terms: {
    ...
    content:
      ...
      '<p>Reference to "OneBet", "We", "Us" or "Our" is reference to onebet.cm’s corporate entities.</p>' +
      ...
      '<p>1.6 Unless otherwise stated, all examples given on the Website are given in XAF. For any transaction which requires a currency exchange, the applicable exchange rate will be the mid-rate as quoted by the Financial Times. The currency options available are listed in Appendix One to these Terms and Conditions and on the Website.</p>' +
      ...
      '<p>The minimum bets amount for each order is the relevant value defined below based on the currency of the user’s account:-XAF 200.</p>' +
      '<p>Maximum Winnings</p>' +
      '<p>The maximum winnings for each bet is the relevant value defined below based on the currency of the user’s account:-XAF 1,000,000.</p>' +
  ...
  howToPlay: [
      ...
      list: [
        {
          ...
          art:
            ...
            '<br> 3. Incase PIN authorization hasn’t pop up in 30 second, manually dial #150*50# (ORANGE) or *126# (MTN) to authorize.'
        },
        {
        ...
        },
        {
          ...
          art:
            'The minimum deposit amount is XAF 50 per transaction.\n' +
            '<br> The maximum deposit amount is XAF 1,000,000 per transaction.'
        }
      ]
    },
    {
      ...
      list: [
        {
          ...
          art:
            ...
            '<br> Notice: You must complete the confirmation through entering the verification code you have received from SMS for your first withdrawal.'
        },
        {
        ...
        },
        {
          ...
          art:
            'The minimum withdraw amount is XAF 500 per transaction. The maximum withdraw amount is XAF 100,000 per transaction.' +
            '<br> The Maximum Daily transaction value is XAF 1,000,000.'
        }
      ]
    },
    {
      ...
      list: [
        ...
        },
        {
          ...
          art: 'If you have forgotten to check in yesterday, you will not get the coins for yesterday. Kindly make sure to check in everyday.'
        }
      ]
    },
    {
      ...
      list: [
        {
          ...
          art: 'Usually, there will be 8-13 selected matches from the official leagues. Make your own predictions on matches or you can choose auto pick options, and then pay for it. When you correct-predicted all matches, you can get XAF 1M prize immediately. Gifts are not available for Daily Jackpot.'
        },
        {
          title:
        ...
        {
          title: '3. The time for Daily Jackpot settlement',
    ...
    },
    {
      ...
      list: [
        {
          title: '1. How to bet?',
          art: 'You can place different kinds of bets: singles, multiples and system (combined) bets. After you have made your choices, you must click betslip to pay for them. The minimum stake is XAF 50 per bet.'
        },
        {
          title: '2. Can I cancel a bet?',
          art: 'Yes, you can cancel your bet on condition that all the matches you bet didn’t start. Then the stake money will be refunded to your balance in several minutes.'
        },
        {
          title: '3. The time for settlement',
      ...
      list: [
        {
          ...
          art: 'Gift can only be used in your betslip and they can be deducted some money from your total payment. Gifts can be used for sports and live betting. Gifts are not available in Jackpot, Daily Jackpot and Intimate bet. '
        },
        {
          ...
          art:
            ...
            '<br> e.g.: ' +
            '<br> a 100 cash gift needs a stake of 500 or more, total odds > 3.2;\n' +
            'You have to choose a match with odds>3.2 and place a stake of 500 or more before you can use this gift.'
        },
        {
  ...
  firstDeposit: {
    title: 'WELCOME BONUS',
    conspicuous:
      'Get up to <span>100,000 XAF</span> free bet gifts on your first deposit',
    time: 'Deal ends in',
    deposit: 'Deposit',
    get: 'Get extra ',
    cash: 'Cash Gifts',
    ...
    title2: 'Attention',
    art3: '1.Only MTN & ORANGE customers can take part in this promotion.Please make sure there is sufficient balance in your mobile money account.',
    art4: '2.The pop up is a primary authorization tool in case the network is having intermittent service. They may fail to send the pop up then you need manually to approve the transaction.#150*50# (ORANGE) or *126# (MTN)',
    terms: 'Terms and conditions:',
    termsList: [
      '1. Each account can get this Cash Gifts only once.',
      '2. Make a first deposit of XAF 500 / 1000 / 10000 / 50000, and you get Cash Gifts value of XAF 1000 / 2000 / 20000 / 100000.',
    ...
    reminder: {
      ...
      submit:
        'Submit successfully. Incase PIN authorization hasn’t pop up in 30 second, manually dial #150*50# (ORANGE) or *126# (MTN) to authorize. Otherwise, you have to try again by tapping deposit button.'
    },
    login: 'Login',
    register: 'Register',
    continue: 'Continue'
  ...
  inviteFriend: {
    ...
    fp: 'FreeBet Payout',
    rewards: 'Rewards',
    rftf: 'Refer friend to finish registration on OneBet, both of you can get <span>100 XAF FreeBet</span>',
    rewardsStep: [
      'Refer Friends',
      'Friend completes <br> registration',
      'Both get <br> <span>100 XAF FreeBet</span>'
    ],
    sm: 'Social Media',
    ...
    rules: [
      '1. Reward',
      'Refer friend to finish registration on OneBet, both of you can get 100 XAF Freebet.You can check Account —> My Authority —> FreeBet',
      '2. Freebet',
      [
        ...
        "c.Unlock condition: Invitee's betting amount on OneBet need to be reached 2,000 XAF",
    ...
    title1: 'YOU GOT A TOTAL OF <br> XAF <span>{gifts}</span> IN GIFTS',
    viewMore: 'VIEW MORE',
    ...
    share: 'SHARE',
    item2:
      '2. Gifts will be credited to both participants’ accounts after your friend made bet stakes in a total value of XAF 2,000 or above. Gifts can be viewed by going to ',
    bonus: '"My Gifts"',
    terms: 'Terms and Conditions:',
    terms1:
      '1. When a newly referred customer place bets worth XAF 2,000 or more, you can get 2,000 Bonus and your referred friend can get 1,000 Bonus;',
    termsA:
      '   A. A newly referred customer at OneBet must place a total amount of Stakes with all Odds of 2.0 or above which account for a total of XAF 2,000 or more (can be placed at different times).',
    ...
    terms3:
      '3. Once the newly referred customer meets the Stake Conditions (A, B and C) to obtain a "Cash Gift", a "Cash Gift" of XAF 1,000 will automatically be credited to the newly referred customer and a "Cash Gift" of XAF 2,000 will be credited to the referrer’s account.',
    terms4:
    ...
    totalBonus: 'Total Gifts Return: XAF ',
    friend: 'Friend',
    Stake: 'Stake',
    Settled: 'Settled',
    ...
    invite: 'Invite Now',
    shareWords:
      'I invite you to join me in Winning Big at OneBet! Register now to get 100,000XAF cash gifts! High odds, Quick payouts, Free withdrawals, Enjoy the best live betting gaming Via:',
    reminder:
  ...
  betSharing: {
    ...
    list1: [
      '1. In order to participate in this promotion, visit our website and click on either ‘Register’ (if you are a new Onebet customer) or login.',
    ...
    title3: 'How to share?',
    list3: [
      "Way 1. Choose market and place your bet, Click <span style='font-weight: bold'>SHARE NOW</span> on your bet successful page",
      "Way 2. Go to 'My Bets', enter your ticket and click <span style='font-weight: bold'>SHARE BET</span> button."
    ]
  },
  betSharingRank: {
    ...
    art1:
      ...
      'You are only one step away from 10,000,000 XAF. Place your Bet and share now!',
    art2:
  ...
  appDownload: {
    ...
    install:
      "<span style='font-weight: bold;'>INSTALL THE ONEBET APP NOW!</span><br> and get a <span style='color: #FCFF00;font-weight: bold;'>2,000 XAF</span> - Gifts!",
    listOne: ['Fast & Light', 'Simple Secure', 'Save Bundles'],
    listTwo: ['Casino', 'Virtual']
  },
  downloadActivity: {
    row1: "First time login on APP <br> Get <span style='color: #FD4505'>1,000 Cash Gift</span>",
    ...
    list: [
      ...
      '2.Each device/IP can only get the 1,000 Cash Gift once;',
  ...
  newbieExclusive: {
    betNow: 'Bet Now',
    boxList: [
      "<span style='color: #FF602F;font-weight: 800; font-size: 0.33333334rem'>50 Free Bet given away</span><br>Daily first bet successfully",
      "<span style='color: #FF602F;font-weight: 800; font-size: 0.33333334rem'>20% stake back</span><br>Daily first bet lose",
      "<span style='color: #FF602F;font-weight: 800; font-size: 0.33333334rem'>5,000 Cash Gift</span><br>Continuous 7 days' Check-in",
      "<span style='color: #FF602F;font-weight: 800; font-size: 0.33333334rem'>Unexpected Bonus</span><br>Continuous bets weekly",
      "<span style='color: #FF602F;font-weight: 800; font-size: 0.33333334rem'>Up to 100,000 Cash Gift</span><br>First Deposit"
    ],
    terms: [
      '1.50 free bet only available for successfully daily first bet;',
      '2.The odds of daily first lose bet must eaquals or more than 5.5, then 20% stake will be refund;',
      "3.5,000 Cash Gift only available for 7 consecutive days' check in;",
  ...
  freeBetPromotion: {
    ...
    list: [
      '1. Each account can only claim 10,000 XAF FreeBet per day;',
  ...
  depositSuccess: {
    ...
    art2: 'The pop up is primary authorization tool in case the network is having intermittent service. They may fail to send the pop up then you need manually to approve the transaction. #150*50#(Orange) or *126#(MTN)',
  ...
  bettingIncentives: {
    ...
    rules: 'RULES',
    rulesItem:
      '1. One customer can participate 3 times a day;<br>2. Place 2 Bets (Odds ≥ 1.50, Stake ≥ 500) will earn you a free chance.',
    rewards: 'REWARDS',
    rewardsItem:
      '<span style="color: #FFF16C;">First prize</span> - Samsung Galaxy S21+ 5G, 6.7 - Phantom Silver<br><span style="color: #FFF16C;">Second prize</span> - 50,000 Airtime<br><span style="color: #FFF16C;">Third prize</span> - 5 G Mbs<br><span style="color: #FFF16C;">Fourth prize</span> - 100 FreeBet<br><span style="color: #FFF16C;">Fifth prize</span> - 100 Cash Gift<br><span style="color: #FFF16C;">Sixth prize</span> - 50 FreeBet<br><span style="color: #FFF16C;">Seventh prize</span> - 50 Cash Gift',
    rewardsDes:
  ...
  topMsgPop: {
    ...
    congrat: 'Congrats! You win 1,400 FreeBet today',
    activate:
      "Activate your <span style='color: #FF0000'>1,400</span> FreeBet and use it now!",
  ...
  onebetLeague: {
    ...
    rules: [
      ...
      `<b>Cashout amount range:</b> Onebet will calculate a real-time withdrawal amount range according to the  match status and clients' betting amount.
        <br>-- minimum cashout amount 20 XAF
        <br>-- Cashout function will not be available when your winning amount less than 50 XAF`,
    ...
    strObj: [
      'Are you sure to cashout {amount} XAF? The rest amount {restNum} XAF will be your new Stake in this ticket after cashout. This operation is irreversible!',
      'Are you sure to cashout all the Stake {amount} XAF in this ticket? This operation is irreversible!'
    ],
    co: 'Cahout Offer',
    rc: 'Request Cashout',
  ...
  virtualFreebet: {
    ...
    con: 'Congratulations!',
    conWord:
      'The result is {home_score}:{away_score}, Your winning {win} XAF has been credited to your OneBet account.',
  ...
  uefaHall: {
    ...
    word: 'Predict who will be the Champion of EURO to <br> share million cash bonus!',
    predict: 'Predict',
    ...
    li2: "2.Complete below task to get <span style='color: #FDD445;font-weight: bold;'>100 Bonus</span>.",
    checkIn: 'Check in',
    checkedIn: 'Checked in',
    completed: 'Completed',
    ...
    reminder1:
      'Congrats! You completed the EURO 2020 daily task and get 100 bonus. ',
    reminder2:
      'Congrats! You get XAF 100 GIFT for betting EURO 2020 match successfully. '
  },
  uefaToday: {
    word: "You can FREE choose one team to support, if the support team win you will be reward <span style='color: #FDD445;font-weight: bold;'>100 bonus</span>",
    title: 'Want to get more bonus?',
    word1:
      "There are more UEFA EURO2020 matches can be chosen. If the betting amount over <span style='color: #FDD445;font-weight: bold;'>XAF 10,000</span> in any game, You can have a chance to support another team",
    support: 'Support',
    confirm: 'Confirm',
    bonus: "Bonus don't stop!",
    word2:
      "Get <span style='color: #FDD445;font-weight: bold;'>100 XAF</span> gift by choosing any match of today's UEFA EURO 2020 to place a bet below",
    termsList: [
      '1. Promotion valid: 2021.06.12 - 2021.07.12.',
      '2. Place any match of UEFA ERUO 2020 can get XAF 100 gift.',
  ...
  uefaChampion: {
    ...
    final: 'Final match time: 11/07 20:00',
    title1:
      "Choose your champion of UEFA EURO2020 <br> to share <span style='color: #FC6F12;font-weight: bold;'> million cash bonus</span>",
    confirm: 'Confirm',
    termsList: [
    ...
    success2:
      "You got a total of <span style='color: #FDD445;font-weight: bold;'>XAF {amount} cash bonus</span>",
    ...
    list: {
      ...
      word: "There are <span style='color: #FF2626;font-weight: bold;'>3,550</span> people who correctly predict during Champion of Euro 2020 will going to share <span style='color: #FF2626;font-weight: bold;'>2,000,000 XAF</span>! Check out whether you are in the list!",
      modalTitle: 'Champion of Euro 2020',
      modalWord: '2,000,000 XAF <br> has been given away! Check it out!',
      button: 'Check'
    }
  },
  dailyGiveaway: {
    ...
    share:
      "Split up <span style='font-size: 0.6667rem;font-weight: bold'>5,000,000</span> XAF",
    clipReminder: 'Choose a card to get your bonus',
    winModal: {
      title: 'Congratulations',
      content:
        'You get <span style="font-size: 0.80556rem;font-weight: bold;color: #FF452C">{amount} </span> <span style="font-size: 0.5556rem;font-weight: bold;color: #FF452C">CASH</span> only <span style="color: #FF452C">{left_amount} XAF</span> away to withdraw!',
      button: 'ACCEPT'
    },
    withdraw: {
      title: 'MY CASH',
      deal: 'Deal ends in',
      word: 'You are only {left_amount} XAF away from withdraw {withdraw} XAF share this promotion to your friends to get.',
      share: 'SHARE',
      friends: 'Friends',
      betting: 'Betting',
      increase: 'Increase',
      ...
      inviteModal:
        "You are only <span style='color: #FF452C;font-weight: bold'>{left_amount} XAF</span> away to withdraw! Invite friends to join this event to help you cashout.",
      inviteButton: 'INVITE FRIENDS',
      shareTitle: 'DAILY SHARE 5,000,000 XAF',
      shareContent: 'Invite your friends to share 5,000,000 XAF'
    },
    canWithdraw: {
      title: 'Congratulations!',
    ...
    successReminder:
      'You already shared today’s 5,000,000 XAF, please come back tomorrow'
  },
  giveawayShare: {
    title: 'MY WITHDRAW AMOUNT',
    share: 'SHARE',
    art: 'Invite your friends to join OneBet and <span style="color: #FFEA00;font-weight: bold">share 5,000,000 XAF</span> too!'
  },
  giveawayInvite: {
    shareTitle: 'Daily 5,000,000 XAF giveaway | OneBet\n',
    shareContent:
      'To complete only 3 tasks can share 5,000,000 XAF on OneBet! Join to get the money now!\n',
    title: 'DAILY SHARE',
    join: 'JOIN NOW',
    item1: {
      amount: '500.00',
    ...
    item2: {
      amount: '1,000.00',
      name: 'Michael',
      word: 'I withdrew 1,000 XAF successfully!',
      content1:
        "<span style='color: #333333;font-weight: bold'>Kadhafi:</span>Wow! Me only withdrew 300 XAF today",
      content2:
    ...
    item3: {
      amount: '500.00',
      name: 'Andasio',
      word: '2 mins easily cash out 500 XAF',
      content1:
    ...
    item4: {
      amount: '300.00',
      name: 'Johnson',
      word: 'Not lucky today, I invite 6 people only 2 helped me. And I only get XAF 300.',
      content1:
  ...
  makka: {
    word: "Bet XAF 300 stands a chance to be today's winner, good luck!",
    prizes: 'Prizes:',
    art1: '— Daily 1000 winners of XAF 2,000 each.',
    art2: '— Grand winner of XAF 80,000/= on 9th August 2021.',
    open: 'Open to all new and existing customers:',
    li1: '1.Customers will be required to place a cash bet on at least one or more OneBet League(OneBet Virtual Games) matches using a stake of 300/= or more. They will automatically enter into the draw to win daily prizes. Continus betting 7 days in OneBet League will automatically enter into the draw to win Grand prizes.',
  ...
  christmas: {
    ...
    completeInfo:
      "Complete avatar and nickname to wear your own Christmas Decoration and get <span class='money'>500 XAF</span> FreeBet!"
  },
  christmas_preheat: {
    ...
    word2:
      "Free Spin to <br> Win up to <br><span style='color: #FFEF3D;font-size: 0.55556rem;'>XAF 100,000</span>",
    word3:
  ...
  christmas_spin: {
    ...
    termsList: [
      ...
      'XAF 500 ≤ The first level ≤ XAF 999,',
      'XAF 1,000 ≤ The second level ≤ XAF 4,999,',
      'The third level ≥ XAF 5,000.',
  ...
  orange: {
    title: '{operator} Exclusive',
    claimSuccess: 'Claim success',
    claimed: 'you have already received',
    only: 'this promotion only available for {operator} users',
    word1:
      "In order to thank users' great support, {operator} user will get <span style='color: #F45F1C; font-weight: bold;'>6</span> exclusive bonus.",
    word2: 'Only if you are an {operator} user can get below bonus:',
    word3:
      'You are not an {operator} user, be an {operator} user to get exclusive bonus!',
    claim: 'Claim Now',
    register: 'Register Now',
    daily:
      "Daily bet over 2,000 XAF in PreMatch/Live will get you <span style='color: #F45F1C; font-weight: bold;'>200 XAF</span> Freebet.",
    get: 'Get Now',
    check: 'Check Freebet',
    betOnly:
      "Bet only <span style='color: #F45F1C; font-weight: bold;'>5</span> (<s>10</s>) times in onebet League( Virtual Sports) to get one Freebet for onebet league.",
    freebet: 'Freebet of Onebet League:',
    deposit1:
      "1. Daily deposit amount ≥ 2,000 XAF can get you <span style='color: #F45F1C; font-weight: bold;'>200XAF</span> cash gift on OneBet;",
    deposit2:
      "2. Weekly deposit amount ≥ 20,000 XAF can get you <span style='color: #F45F1C; font-weight: bold;'>2,000 XAF</span> cash gift on OneBet.",
    deposit: 'Deposit Now',
    tips: "Tips: The BONUS in this promotion won't influence other promotion bonus",
    rules: 'RULES',
    list: [
      "1. In order to thank MTN's support, this promotion only available for MTN users;",
      '2. All the coins, gift and Freebet in this promotion will be directly credited to your OneBet account, kindly check and use it in time;',
      '3. OneBet reserves the final explanation right.'
    ],
    depositReminder:
      "Deposit with {operator} you can get Extra Bonus, <span style='text-decoration: underline; color: #447ED9'>Check Details</span>",
    registerReminder:
      "Register with {operator} number will get you 6 Exclusive Bonus, <span style='text-decoration: underline; color: #447ED9'>Check Now</span>",
    orangeReminder:
      'This promotion is only for MTN user, you are a orange user. Login your MTN account to get FREE Freebet？',
    coutinue: 'Go on bet',
  ...
  epl: {
    ...
    shareArt:
      'I invited you to join me in FREE sharing 1,000,000 XAF at OneBet! Place a bet on EPL matches to unlock your qualification now:\n',
    predictTitle: 'Unlock EPL Predict successfully!',
    predictContent:
      'Now you can Predict EPL Free and have a chance to win 1,000,000 XAF.',
  ...
  hottestTickets: {
    ...
    Reward: 'Reward',
    Rules: 'Rules',
    bigCake: ['1,000,000 XAF', 'Bonus for Every Week!'],
    ...
    detailsList: [
      {
        ...
        list: [
          "1st place, <span style='font-weight: bold;'>1,000 XAF cash</span>;",
          "2nd place, <span style='font-weight: bold;'>800 XAF cash</span>;",
          "3rd place, <span style='font-weight: bold;'>500 XAF cash</span>;"
        ]
      },
      {
        title:
        ...
        list: [
          "1 ~ 3 place, <span style='font-weight: bold;'>2,000 XAF cash + 2,000 XAF Freebet + 6,000 XAF gift</span>;",
          "4 ~ 6 place, <span style='font-weight: bold;'>1,000 XAF cash + 1,000 XAF Freebet + 3,000 XAF gift</span>;",
          "7 ~ 10 place, <span style='font-weight: bold;'>500 XAF cash + 500 XAF Freebet + 1,000 XAF gift</span>;"
        ]
      },
      {
        title:
      ...
      {
        title:
          "5.All players who shared tickets will get a <span style='font-weight: bold;'>100 XAF</span> gift in the day;"
      },
      {
    ...
    bannerCopywriting: 'Share Your Bet to win 1,000,000 XAF Every week',
    ...
    betslipTips: `Share ticket to win <span style='color:${mainThemeColor}'>1,000,000 XAF</span> Bonus every week!`,
  ...
  backup: {
    ...
    art: 'You can add an alternate number, one account can at most add 1 MTN phone number and 1 Orange phone number.',
    sendCode: 'Send Code',
  ...
  influencerChannelActivities: {
    title: "Fingon Tralala's Bonus",
    middleTitle: '10,000XAF Exclusive Gifts',
    rulesTitle: 'Terms and Conditions',
    rulesList: [
      '1. This Exclusive Gifts is from Fingon Tralala;',
      '2. 10,000 XAF gift/freebet have been credited to your account, kindly check and use them in time;',
      '3. You can improve the amount and number of your unlocked freebet/gift in Inflated Bonus;',
      '4. OneBet reserves the final explaination rights.'
    ],
    InflatedBonus: 'Inflated <br> Bonus',
    InflatedTitle: 'Inflated Bonus',
    drawerTip:
      'There is no available freebet/gift, kindly go to unlock and come back to try again.',
    illustrate:
      'You can randomly use a gift/freebet to draw in this game to improve its number and amount.',
    start: 'Start',
    tips: 'Tips: You can only play this game once a day',
    notice:
      'One of your {qnumber} XAF {type} has been inflated to {number} x {hnumber} XAF {type}.',
    typeTitle: ['Type', 'Amount', 'Number'],
    pageRulesList: [
      [
        "<div class='ask'>1.Q: What's in Fingon Tralala 10,000 XAF Exclusive Bonus?</div>",
        'A:',
        '1. It contains 3,000 XAF FreeBet and 7,000 XAF Gift.',
        '2. Freebet: 100 XAF x 5 + 150 XAF x 10 + 200 XAF x 5 = 3,000 XAF',
        '3. Gift: 100 XAF x 15 + 250 XAF x 10 + 500 XAF x 6 = 7,000 XAF'
      ],
      [
        "<div class='ask'>2.Q: What is Gift?</div>",
        "A: Go to <span class='FingonTralalaActivityRuleLink'>How to use Gift</span> to check."
      ],
      [
        "<div class='ask'>3.Q: What is Freebet?</div>",
        "A: Go to <span class='FingonTralalaActivityRuleLink'>How to use Freebet</span> to check."
      ],
      [
        "<div class='ask'>4.Q: Why some of the Gift and Freebet are unable to use, the use button is gray?</div>",
        'A: Each Gift/Freebet has a using time, kindly confirm the start time and wait to use.'
      ],
      [
        "<div class='ask'>5.Q: Why my Freebet is locked?</div>",
        'A: You should achieve the unlock condition of each Freebet before it can be used.'
      ],
      [
        "<div class='ask'>6.Q: Why can't I draw?</div>",
        'A:',
        '1. Kindly check if you have available Gift/Freebet.',
        '2. Did you already drew today, everyone can only play once a day.'
      ],
      [
        "<div class='ask'>7.Q: Why my Freebet/Gift disappeared before I use it?</div>",
        'A: Each Gift/Freebet has a valid time, kindly confirm and use it in time.'
      ],
      [
        "<div class='ask'>8.Q: Where can I get more Freebet/Gift?</div>",
        'A:',
        '1. Participate first deposit promotion to get 200% deposit bonus;',
        '2. Play Coins Spin to get;',
        '3. Join our promotions and bet on OneBet.'
      ]
    ]
  },
  a2hs: {
  ...
  rushHour: {
    ...
    rushHourRules1:
      'Play Crash Game 20, 50, 100 and 200 times during each Rush Hour time can get bonus;',
    rushHourRules2:
      'Play Crash Game within these specified periods can get you an extra Bonus;',
    rushHourRules3:
  ...
  saveMoneyCasino: {
    hotGames: 'Hot Games',
    title: 'casino saving card',
    bgTitle: "Join to get <span style='color: #F79B00;'>1232</span> XAF Gifts",
    notStartTitle: 'Casino available Gifts, highest save ',
    notStartTotal: 'Total 114 Gifts',
    betOver: 'Bets Over ',
    claim: 'Claim',
    bet: 'Use Now',
    used: 'Used',
    expired: 'Expired',
    notice: 'Claimed Gifts will be expired after 24 hours',
    notice1: 'Notice',
    notice2:
      'Place 1 XAF on OneBet Casino equal 1 OneBet Casino point, the accumulative OneBet Casino points in the past 31 days >/= 500',
    notice3: ',  you can open casino saving card.',
    top1: 'Hi, your currently OneBet Casino points ',
    top2: 'accumulative money saved',
    top3: 'OneBet Casino points',
    top4: 'Expire on',
    top5: 'Expired on',
    art1: 'XAF able to claim in this month',
    art2: 'Claimed in this period',
    card1: 'Monthly Package',
    card2: 'First Month 0 XAF',
    card3: 'Available 31 days',
    card4: 'XAF 56',
    card5:
      'Able to join after OneBet Casino points over 500; <span>place 1XAF stake in casino = 1 OneBet Casino point</span>',
    card6: 'Bet',
    card7: 'Currently OneBet Casino points:',
    card8: 'Trial 0 XAF',
    card9: 'Claim Now',
    payment1: 'Payment Successful',
    payment2: 'Your OneBet Casino saving card opened successfully.',
    payment3: 'casino available gifts can be claimed during the period!',
    noGift: 'There is no available Gifts, kindly claim first',
    noUse: 'There is no used Gifts',
    noExpire: 'There is no expired Gifts',
    middle1: 'One press to claim one gift',
    middle2: 'gifts left today',
    middle3: 'Use 50 Gifts to unlock 59 Gifts',
    renewal1:
      "All the Gifts in this period has been claimed, renew now to get another <span style='color: #F79B00;'>1232</span> XAF Gifts next period",
    renewal2: 'Renew Now',
    renewal3:
      'casino saving card has been renewed,<br>' +
      'Time of next distribute Gifts is ',
    payError1: 'Insufficient Balance',
    payError2: 'Insufficient balance, please deposit first',
    payError3: 'Deposit Now',
    payError4: 'Abandon 1232 XAF',
    payError5: 'Error Network',
    payError6: 'The network is poor, kindly try again later',
    payError7: 'Try Again',
    payError8: 'Cancel',
    payError9: 'Payment Failed',
    payError10: 'Payment failed, kindly contact our customer service for help',
    payError11: 'Contact Customer Service',
    payError12: 'Close',
    claimSuccess: 'Claim Successfully',
    keepClaim: 'Keep Claiming',
    goUse: 'Go to use',
    claim1: 'Claim successfully, {amount} Gifts still available today',
    claim2: "Claim successfully, all today's gifts claimed empty",
    claim3: '5 Gifts has been claimed today, kindly come back tomorrow',
    claim4:
      'All the Gifts in this period has been claimed, kindly come back next period',
    casino1:
      "<span>{x} XAF</span> wasn't claimed yet in this period, expired in <span>{y}</span> days",
    casino2: '<span>{w}</span> Gifts will be expired soon, kindly use in time.',
    casino3:
      'Accumulated saved <span>{m} XAF</span>, renew to get another <span>1232 XAF</span>',
    casinoRemark: 'Available for',
    nextStep: 'Next Step',
    guide: [
      "Press 'Claim' to get Gifts",
      "Slide left or right to check more Gifts; press 'Claim' to get Gifts.",
      "Press 'Available' to check claimed Gifts",
      'Choose any game below to use Gifts'
    ],
    v2art1:
      "There are still <span  style='color: #FFE89F;'>56 XAF</span> to be claimed today",
    v2art2:
      "There are still <span  style='color: #FFE89F;'>{x} XAF</span> to be used today",
    v2art3: "Total saved <span  style='color: #FFE89F;'>{x} XAF</span>",
    v2art4:
      "Total saved <span  style='color: #FFE89F;'>{x} XAF</span>, Renew to get another <span  style='color: #FFE89F;'>1232 XAF</span>",
    v2art5:
      "Renew to get another <span  style='color: #FFE89F;'>1232 XAF</span>",
    v2art6: 'Use',
    v2art7: 'Tap to Claim',
    v2art8: 'Gifts expired',
    v2art9: 'Gifts used',
    v2art10: 'Gifts available',
    v2art11: 'times collect left',
    v2art12: 'Able to collect {x} times',
    v2art13: 'Come Back Tomorrow',
    v2art14:
      "Already saved <span  style='color: #FFE89F;'>{x} XAF</span>, you can get another <span  style='color: #FFE89F;'>56 XAF</span> tomorrow",
    v2art15: 'Unlock 12 times collect after used 50 gifts',
    v2art16:
      '<span style="color: #F79B00">{r_use}</span> gifts have been used, <span style="color: #F79B00">{r_left}</span> gifts need <br> to be used to unlock\n'
  },
  timeLimitedActivity: {
    joined: 'Joined ',
    value: 'Value',
    title1: 'Time Limited Bonus',
    title2: 'Participate Players:',
    left: 'Left',
    total: 'Total',
    chooseNum: "Random choose <span style='color:#000000'>{num}</span> players",
    conditions: 'Participate Conditions',
    unaccomplished: 'Unaccomplished',
    accomplished: 'Accomplished',
    waitingResults: 'Waiting for results...',
    clickJoin: 'One Click to Join',
    participated: 'Participated',
    deposit: 'Deposit on OneBet',
    register: 'Register as a OneBet member',
    congratulations:
      "Congratulations!You win<br/> <span style='color:#FF3F38;font-weight:900;font-size:0.47rem'>{num}</span> {rewardType}",
    checkReward: 'Check Reward Record',
    close: 'Close',
    notWinner:
      "Sorry!<br/>You didn't win anything this time. Winning list display as below:",
    participateBetting: 'Participate {bettingName} Betting',
    stake: 'Stake',
    matches: 'Matches',
    odds: 'Odds',
    freeJoin: 'Free to Join',
    rules: [
      "'Time Limited Bonus' includes CASH, OneBet Freebet, OneBet sports gifts, OneBet Casino Gifts, OneBet Leauge Freebet, Coins and etc. Kindly read the rules carefully to learn the designated award. All the reward will be automatically credited to player's account.",
      "Rules of 'Time Limited Bonus' , system will purely random method will be used to draw the prizes fairly and equitably among users who participate in the event and meet the prerequisites for the draw.",
      "There won't be any service fee of this promotion, Players who meet the prerequisites for the draw and click the one-click to join button during the event period will be eligible to participate in the draw.",
      "The reward of 'Time Limited Bonus' will be draw as soon as the promotion finish. Players can see the draw result directly on the pop-up. If one missed the draw time, he can check the result in account inbox.",
      'There will be different promotions on multiple page at the same time, players can participate multiple promotion contemporarily.',
      "OneBet reserves the final explanation right of 'Time Limited Bonus' promotion"
    ]
  },
  newUserBenefits: {
    title: 'New User Exclusive',
    claimUp: 'Claim up to 600 XAF Gift within the first 30 registration days',
    claimAfter: 'Claim after registration',
    betDays: 'Claim after bet {num} days',
    registerNow: 'Register Now',
    claimDuring: 'Able to claim during ',
    claim: 'Claim',
    useItNow: 'Use it Now',
    alreadyUsed: 'Already used',
    claimTomorrow: 'Claim Tomorrow',
    expired: 'Expired',
    expireAfter: 'Expire after ',
    activityExpired:
      'Registration is over 30 days, the promotion is not available any more!',
    failedClaim: 'Failed to claim, kindly try again later.',
    oneCan:
      'One can at most claim 1 exclusive {category} per day, kindly come back tomorrow.',
    OK: 'OK',
    accumulated: 'Accumulated bet {num} day to claim this {category}.',
    goToBet: 'Go to Bet',
    directions: '2.Directions',
    directionsList: [
      "1. The conditions of claiming a {category} are on its bottom, e.g.: 'Bet 3 days to Claim' means you need accumulated bet 3 days to claim this {category};",
      '2. New User Exclusive {category} only available for Sports Betting;',
      '3. User can at most claim 1 New User Exclusive {category} per day;',
      '4. New User Exclusive {category} will be expired after claimed 24 hours;',
      '5. All the unclaimed {category} will be disabled after 30 days of your registration.'
    ],
    congratulations: "Completed today's bet!",
    sendsGift: 'OneBet sent you',
    exclusiveGift: 'New User Exclusive {category}',
    claimNow: 'Claim Now',
    checkMoreDetails: 'Check more details>',
    claimSuccessful: 'Claim successful',
    hours: "Please use it within <span style='color: #ED2136'>24 hours.</span>",
    stakes: 'Stakes >= ',
    odds: 'Odds >= ',
    market: 'market >= ',
    gift: 'Gift',
    betNow:
      "tomorrow can claim <span style='color: #ED2136'>{num} XAF</span> {category}.",
    betNow2:
      "Bet now to Claim <br/> <span style='color: #ED2136'>{num} XAF</span> {category}.",
    checkMore: 'Check More >',
    whatGiftsTitle1: '1.What is Gifts',
    whatGiftsContent1:
      "Gifts can be used to reduce your stakes while placing bet. <span style='color: #4C50FA;text-decoration-line: underline;'>How to use Gifts?</span>",
    whatGiftsTitle2: '1.What is Freebet',
    whatGiftsContent2:
      "Freebet can be used to bet free on Freebet page. <span style='color: #4C50FA;text-decoration-line: underline;'>How to use Freebet?</span>",
    betNowAndTomorrow0: 'Bet now to claim',
    betNowAndTomorrow1: 'Bet tomorrow to claim'
  },
  claimCom: {
    time1: 'Kindly use it within <span>{time}</span> days',
    time2: 'Able to claim within <span>{time}</span>',
    title1: 'Claim successful',
    title2: 'Time limited exclusive subsidies',
    giftname: 'Sports available gift',
    more: '<span>{num}</span> {name} are able to claim',
    exday: 'Expire in {time} days',
    extime: 'Expire after {time}'
  },
  forgotPsd: {
    verificationCode: 'Verification Code',
    send: 'Send',
    change: 'change',
    tryAgain: 'Incorrect code, kindly try again.',
    joinSuccess: 'Join Successful',
    savePsd: "Don't forget to save your account and password",
    saveFile: 'Save as file',
    saveImg: 'Save as image',
    saveEmail: 'Send to E-mail',
    sendedEmail:
      'The password and account have been sent to your E-mail successfully !',
    inputEmail: 'Input your E-mail',
    enterAmount: 'Enter your deposit amount',
    save: 'Save',
    inputPhoneResetPsd: 'Input phone number to reset your password',
    enterCodeModifyPsd:
      'A 4 digit code has been sent to {num}. Enter the code to modify your password.',
    enterCodeModifyPsdTip: 'Tips: You can also check the code in your E-mail: ',
    inputNewPsd: 'Input new password',
    enterCode: 'Enter Code',
    saveNewPsd: 'Save New Password',
    txid: 'Txid',
    noFoundTxid:
      "We found the Txid: {num1} deposit wasn't  made by account : {num2}, kindly input a correct Txid to try again.",
    enterTransactionIDModifyPsd:
      "Enter any deposit successful Transaction ID of account : {num} to modify it's password.",
    enterTransactionID: 'Enter Transaction ID',
    enterVerificationCode:
      'Enter the deposit successful message sent by {phone}',
    fullMessage: 'Enter the Transaction ID of {phone} or the full message here',
    modifyPsdSuccess: 'Modify Password Successfully',
    website: 'Website',
    smcCode: 'SMS Code',
    emailErrorTip: 'Please enter a valid email address',
    captchaErrorTip: 'Kindly enter a valid 4 number code',
    beforeSending:
      'Go to send account {num} SMS message verification code. Enter verification code to change your password'
  },
  fiveLeague: {
    prizesQuiz: 'Prizes Quiz with',
    topFive: 'Who will be the top five of {epl} in this season?',
    correctlyPredict:
      "Correctly predict the rank of {epl} top 5 teams this season, you will get <span style='color: #FF6C00;'>{num}</span>",
    notStarted: "This activity hasn't started yet. The start time is {time}",
    submit: 'Submit',
    submitted: 'Submitted',
    predictionIncorrect: 'Prediction Incorrect',
    claimRewards: 'Claim Rewards',
    claimed: 'Claimed',
    finished: 'Finished',
    termsConditions: 'Terms and conditions',
    list: [
      "1. Players can make a prediction of the rank for 5 major leagues' top 5 teams in specified time, correctly predict can claim reward;",
      '2. Daily deposit/bet successfully can predict free.'
    ],
    submitSuccess: 'Submit Successful',
    predictedSubmit:
      "You've  predicted the rank of {epl} top 5 teams ! Please wait for the results.",
    congratulations:
      'Congratulations! You correctly predict the rank of {epl} top 5 teams and win {num}.',
    failureMeetConditions:
      'Deposit / Bet to predict free. Please go to deposit / Bet first.',
    waitPatiently: 'Please wait patiently for settlement'
  },
  noFound: {
    oops: 'Oops!',
    pageNotFound: 'Page Not Found',
    pageNotFound2:
      "The page you requested could not be found.We're working on it now:)",
    betOnebet: 'Bet on Onebet:'
  },
  registerFreebet: {
    success: 'Succeed',
    successArt:
      'Account was registered successfully! <br> XAF 100 Freebet bet successfully, check the ticket now?',
    failed: 'Bet Failed',
    failedArt:
      'Account was registered successfully! <br> XAF 100 Freebet bet failed, use it to bet again now?'
  }
}
